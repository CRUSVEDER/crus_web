...
const HeroPost = ({ post }: Props) => {
  ...
  return (
    <section className="relative p-6 mx-auto w-full max-w-7xl bg-gray-100 rounded-2xl shadow-sm opacity-0 md:p-4 dark:bg-gray-700 animate-fade_in">
      <div className="overflow-hidden mb-4 h-auto rounded-t-lg md:mb-8 mask-bottom-strong md:h-[24rem]">
        ...
        {url?.startsWith("http") ? (
          <div
            className="absolute top-12 right-12 z-20 p-2.5 bg-gray-100 rounded-md dark:bg-gray-700"
            title="External"
          >
            <svg

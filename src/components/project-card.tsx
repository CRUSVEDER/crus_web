...
const ProjectCard = ({ project, index }: Props) => {
  ...
  return (
    ...
    >
      <div className="relative bg-gray-50 rounded-md shadow-md border border-gray-200 dark:border-gray-600 dark:bg-gray-700 group">

        <div className="flex relative z-10 flex-col bg-gray-50 rounded-md transition duration-500 dark:bg-gray-800">
          {url && (
            <Link
              href={url}
          ...
          <div className="flex relative z-10 p-6 align-middle rounded-b-md">

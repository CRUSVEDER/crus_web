const Blur = () => {
  return (
    <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
      <div className="absolute top-8 right-10 w-96 h-96 bg-pink-200 rounded-full opacity-60 2xl:right-96 dark:opacity-60 max-h-[800px] max-w-[900px] animate-blob mix-blend-multiply blur-3xl lg:h-[60vh] lg:w-[40vw] dark:mix-blend-overlay"></div>
